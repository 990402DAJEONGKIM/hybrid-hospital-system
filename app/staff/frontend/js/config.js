...
// BASE_URL: 온프레미스 백엔드 (office.mzclinic.local nginx → FastAPI /staff/*)
// ONPREM_BASE_URL: 내부 도메인 기반 호출 URL (172.30.1.76 → office.mzclinic.local 로 변경) — by 김다정, 2026-06-06
//   의사 PC hosts 파일에서 office.mzclinic.local = 172.30.1.76 으로 해석됨
