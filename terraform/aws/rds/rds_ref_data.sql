...
INSERT INTO sync_encounters (encounter_id, patient_hash, encounter_type, department_code, doctor_id, visit_hour, status_code) VALUES
    ('e0000000-0000-0000-0000-000000000001', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'OPD',       'INTERNAL', 'a1000000-0000-0000-0000-000000000001', '2025-01-15 10:00:00+00', 'CLOSED'),
    ('e0000000-0000-0000-0000-000000000002', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'OPD',       'CARDIO',   'a1000000-0000-0000-0000-000000000002', '2025-03-20 14:00:00+00', 'CLOSED'),
    ('e0000000-0000-0000-0000-000000000003', '1de0d88279f76ebcb102a03fa2cf569394d10b61e4f135753d89253bae1f106e', 'OPD',       'NEURO',    'a1000000-0000-0000-0000-000000000003', '2025-02-10 09:00:00+00', 'CLOSED'),
    ('e0000000-0000-0000-0000-000000000004', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'ADMISSION', 'SURGERY',  'a1000000-0000-0000-0000-000000000005', '2024-11-05 08:00:00+00', 'CLOSED')
ON CONFLICT (encounter_id) DO NOTHING;

INSERT INTO sync_diagnoses (diagnosis_id, encounter_id, patient_hash, diagnosis_code, is_primary, diagnosed_at) VALUES
...
INSERT INTO sync_allergies (allergy_id, patient_hash, allergy_code, severity_code, is_active, recorded_at) VALUES
    ('f0000000-0000-0000-0000-000000000001', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'PENICILLIN', 'HIGH',   TRUE, '2024-06-01 00:00:00+00'),
    ('f0000000-0000-0000-0000-000000000002', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'ASPIRIN',    'MEDIUM', TRUE, '2024-06-01 00:00:00+00'),
    ('f0000000-0000-0000-0000-000000000003', '1de0d88279f76ebcb102a03fa2cf569394d10b61e4f135753d89253bae1f106e', 'SULFA',      'LOW',    TRUE, '2025-01-20 00:00:00+00')
ON CONFLICT (allergy_id) DO NOTHING;

INSERT INTO sync_surgery_histories (surgery_history_id, patient_hash, surgery_code, surgery_yearmonth) VALUES
    ('g0000000-0000-0000-0000-000000000001', '4242a3bcf13673bba791a95451c6edd9463f3d678a6dba4953a59d2d8112feae', 'APPY', '2024-11'),
    ('g0000000-0000-0000-0000-000000000002', '9b12a6c1bcd456dd582223a31a27a815b734a848e71b254ff5ef12da1ca62dd8', 'CHOL', '2023-08')
